...
interface UsersDao {
    ...
    //Actualiza únicamente la URI del avatar para un usuario específico.

    @Query("UPDATE users SET avatarUri = :avatarUri WHERE email = :email")
    suspend fun updateAvatarUri(email: String, avatarUri: String?): Int // Devuelve filas afectadas (debería ser 1 o 0)
